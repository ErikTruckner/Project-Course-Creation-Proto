...
const slides = [
  {
    ...
    jobDescription: 'Put the details of the job and skills required here',
  },
  {
    jobTitle: 'Job 2',
    datesWorked: ' 2020 - 2023',
...
const WorkExperience = () => {
  ...
  return (
    <section className=' bg-slate-900 relative w-full h-screen overflow-hidden '>
      ...
      <div className='w-full h-full flex flex-col justify-start items-center text-white z-10 my-20'>
